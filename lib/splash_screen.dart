  ...
  void navigateToNextScreen(User? user) async {
    if (user != null && isLogin) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Dashboard()), // Ganti NextPage dengan nama halaman selanjutnya
      );
    });
      } else {
        Timer(Duration(seconds: 3), () {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => MenuUser()), // Ganti NextPage dengan nama halaman selanjutnya
      );
    });
      }
    } else {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => SignScreen()), // Ganti NextPage dengan nama halaman selanjutnya
      );
    });
    }
  }
